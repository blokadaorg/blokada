...
do
    ...
    echo $dartPath
    dart run pigeon --input $file --dart_out lib/platform$dartPath/channel.pg.dart --swift_out libgen/ios/$name.swift --kotlin_out libgen/android/$name.kt --kotlin_package "channel.${name_lower}"
done
