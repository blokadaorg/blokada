...
class MockPaymentChannel with Logging, PaymentChannel {
  ...
  Future<void> showPaymentScreen(Marker m, Placement placement, {bool forceReload = false}) async {
    log(m).w("MockPaymentChannel: showPaymentScreen is a no-op in mocked scheme; placement=${placement.id}. Seed an active dev account in common/lib/dev_seed.dart.");
  }
