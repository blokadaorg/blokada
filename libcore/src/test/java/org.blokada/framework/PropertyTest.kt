...
class PropertyTest {
    ...
    @Test fun property_persisted() {
        ...
        val persistence = object: IPersistence<String> {
    ...
    @Test fun property_persistedWithModification() {
        ...
        val persistence = object : IPersistence<List<Int>> {
...
//        val kctx = newSingleThreadedKContext(j = mockJournal(), prefix = "property")
        val kctx = newConcurrentKContext(j = mockJournal(), prefix = "property", tasks = 10)
        val kctx2 = newSingleThreadedKContext(j = mockJournal(), prefix = "property3")
