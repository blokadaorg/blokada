...
open class Kontext internal constructor(
    ...
    companion object {
        fun new(vararg id: Any) = Kontext(id.joinToString(":") { it.toString() })

        fun forCoroutine(
            coroutineContext: CoroutineContext, id: Any,
            log: Log = DefaultLog(id.toString())
        ) = Kontext(
            id = id,
            log = log,
        ...
        fun forTest(
            id: String = "test", log: Log = DefaultLog(
                id, writer = systemWriter,
