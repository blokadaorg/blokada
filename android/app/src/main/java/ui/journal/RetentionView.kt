...
class RetentionView : FrameLayout {
            ...
            device.retention.collect {
                ...
                if (enabled) {
                    ...
                    retentionContinue.setOnClickListener {
                        switchWorking(true)
                        lifecycleScope.launch { device.setActivityRetention("") }
                    }
                } else {
                    ...
                    retentionContinue.setOnClickListener {
                        switchWorking(true)
                        lifecycleScope.launch { device.setActivityRetention("24h") }
                    }
                }
            }
        }
