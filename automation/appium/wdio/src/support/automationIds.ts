...
export const AutomationIds = {
  ...
  exceptionAddButton: "automation.exception_add_button",
  exceptionDomainInput: "automation.exception_domain_input",
  exceptionSaveButton: "automation.exception_save_button",
  exceptionDelete: "automation.exception_delete",
  recentActivityShowAll: "automation.recent_activity_show_all",
