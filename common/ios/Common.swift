...
struct OpsEnvInfo {
  ...
  static func fromList(_ list: [Any?]) -> OpsEnvInfo? {
    ...
    let buildFlavor = list[2] as! String
    let buildType = list[3] as! String
    let cpu = list[4] as! String
    let deviceBrand = list[5] as! String
    let deviceModel = list[6] as! String
    let deviceName = list[7] as! String
